                        ...
                        const VkCopyMemoryToImageInfoEXT *info)
{
   ...
   TU_FROM_HANDLE(tu_image, dst_image, info->dstImage);
...
{
   TU_FROM_HANDLE(tu_device, device, _device);
   TU_FROM_HANDLE(tu_image, image, info->srcImage);
...
{
   TU_FROM_HANDLE(tu_device, device, _device);
   TU_FROM_HANDLE(tu_image, src_image, pCopyImageToImageInfo->srcImage);
   TU_FROM_HANDLE(tu_image, dst_image, pCopyImageToImageInfo->dstImage);
